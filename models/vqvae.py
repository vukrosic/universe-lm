...
class VQVAE(nn.Module):
    ...
    def decode(self, indices, height, width):
        # indices shape: [B*H*W, 1]
        batch_size = indices.shape[0] // (height * width)
        z_q = self._vq_vae._embedding(indices).view(batch_size, height, width, self._vq_vae._embedding_dim)
