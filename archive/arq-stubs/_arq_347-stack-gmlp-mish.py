"""347-stack-gmlp-mish — stacking matrix on champion 323 (token-mix + FFN-activation).
...
~additive a 3-way clears the 0.02 band even at ~50% efficiency. This stub = use_gmlp_sgu+use_mish_glu.
