"""351-qk-bilinear — NEW attention-structure axis on champion 323 (bilinear QK interaction (learned bilinear form in the attention score)).
...
Stack: 323 champion (combo env + deepnet_alpha + poly_alibi + mom0.90 + x2.0 LR) + use_qk_bilinear.
