"""348-cross-block-ffn-share — NEW structural axis on champion 323 (share W_up/W_down FFN projections across blocks (ALBERT-style cross-block tying)).
...
Stack: 323 champion (combo env + deepnet_alpha + poly_alibi + mom0.90 + x2.0 LR) + use_cross_block_ffn_share.
