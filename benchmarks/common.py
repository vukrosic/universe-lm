...
from configs.llm_config import Blueberry24GBConfig, BlueberryConfig
...
def load_model_from_checkpoint(checkpoint_path, device='cuda', dtype=torch.bfloat16):
    ...
    torch.serialization.add_safe_globals([Blueberry24GBConfig, BlueberryConfig])
    ...
    if 'config' in checkpoint:
        ...
        print("Warning: Config not found in checkpoint, using default Blueberry24GBConfig")
