...
from configs.llm_config import (
    ...
    Screen3M32KConfig,
    Screen10M20MConfig,
    Screen10M20MPerGroupLRConfig,
    Full10M200MConfig,
    Full10M200MPerGroupLRConfig,
    Full135M2700MConfig,
)
...
def main():
    ...
    preset_map = {
        ...
        "screen10m_per_group_lr": Screen10M20MPerGroupLRConfig,
        "10m": Full10M200MConfig,
        "10m_per_group_lr": Full10M200MPerGroupLRConfig,
