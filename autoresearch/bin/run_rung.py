...
ARM_FLAGS = {
    ...
    # Combined long-context arm (all levers together):
    "longcontext_combined": {
        "rope_base": 500_000,               # RoPE: de-alias position at range
        "use_qk_norm_post_rope": True,      # QK-norm: prevent attention saturation
        "use_diff_attn": True,              # Diff-Attn: subtract attention noise
    },
}
